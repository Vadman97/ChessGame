...
public class CompressedGameBoard
{
	...
	public static int CURRENT_PLAYER_FLAG=0b1;
	...
	public GameBoard getGameBoard(){
		...
		board.currentColor=flags&CURRENT_PLAYER_FLAG;
		return board;
	}
	...
	public boolean equals(Object o){
		if(!(o instanceof CompressedGameBoard))return false;
